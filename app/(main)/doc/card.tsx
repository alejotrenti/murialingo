...
export const Card = ({ title, id, imageSrc, onClick }: Props) => {
    ...
    return (
        <div
            onClick={handleClick}
            className="h-full border-2 rounded-xl border-b-4 hover:bg-black/5 cursor-pointer active:border-b-2 flex flex-col items-center justify-between p-3 pb-6  min-w-[180px] lg:min-w-[300px]"
        >
            <Image
                src={imageSrc}
                alt={title}
