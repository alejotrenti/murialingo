  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primaryOutline:"bg-white text-sky-500 border-sky-300 border-2 hover:bg-sky-50 dark:bg-[#020817] dark:text-sky-500 dark:border-sky-500 dark:hover:bg-sky-600",
        ...
        secundaryOutline:"bg-white text-green-500 border-green-300 border-2 hover:bg-slate-50 dark:bg-[#020817] dark:text-green-500 dark:border-green-500 dark:hover:bg-green-600",
        ...
        dangerOutline:"bg-white text-rose-500 border-rose-300 border-2 hover:bg-slate-50 dark:bg-[#020817] dark:text-rose-500 dark:border-rose-500 dark:hover:bg-rose-600 dark:hover:text-white",
        ...
        superOutline:"bg-white text-indigo-500 border-indigo-300 border-2 hover:bg-slate-50 dark:bg-[#020817] dark:text-indigo-500 dark:border-indigo-500 dark:hover:bg-indigo-600",
